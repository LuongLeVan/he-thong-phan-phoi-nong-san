<?php
	...
	include("../../Model/chung/mthanhtoan.php");
	...
	class csanpham{
		...
		function tao_donhang_khachhang_nganhang($madonhang,$makhachhang,$manongsan,$trangthai,$soluong,$magiaodichvnpay,$manganhang){
			$p = new msanpham();
			$ins = $p->tao_donhangkhachhangnganhang($madonhang,$makhachhang,$manongsan,$trangthai,$soluong,$magiaodichvnpay,$manganhang);
			if($ins){
				return 1;
			}else{
				return 0;
