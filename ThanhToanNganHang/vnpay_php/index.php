...
<html lang="en">
  ...
  <!-- Font Awesome -->
    ...
    <body>
        <?php require_once("ThanhToanNganHang/vnpay_php/config.php"); ?>             
        <div class="container">
            ...
            <div class="table-responsive">
                <form action="ThanhToanNganHang/vnpay_php/vnpay_create_payment.php" id="create_form" method="post">       
                    ...
                    <div class="form-group">
                      ...
                      <?php  
                        echo '<input class="form-control" id="amount"
                               name="amount" type="number" value="'.$_SESSION['tongtien'].'"/>';
                    ?>
                    </div>
                    <div class="form-group" style="display: none">
                    ...
                    <div class="form-group">
                        <label >Họ tên (*)</label>
                        <?php
                        echo '<input class="form-control" id="txt_billing_fullname"
                               name="txt_billing_fullname" type="text" value="'.$_SESSION['tenkhachhang'].'"/>';  
                        ?>          
                    </div>
                    <div class="form-group">
                        <label >Email (*)</label>
                        <?php
                        echo '<input class="form-control" id="txt_billing_email"
                               name="txt_billing_email" type="text" value="'.$_SESSION['email'].'"/>';   
                        ?>
                    </div>
                    <div class="form-group">
                        <label >Số điện thoại (*)</label>
                        <?php
                        echo '<input class="form-control" id="txt_billing_mobile"
                               name="txt_billing_mobile" type="text" value="'.$_SESSION['sdt'].'"/>';  
                        ?>
                    </div>
                    <div class="form-group">
                        ...
                        <p class="user-infor form-control">
                            <?php
                             if((isset($_SESSION["login_id"])&& $_SESSION["login_id"]==True)){
                                include("View/akhachhang/vdiachi.php");
                    ...
                    <button style="display: none" type="submit" class="btn btn-primary" id="btnPopup">Thanh toán Post</button>
                    <button type="submit" name="redirect" id="redirect" class="btn btn-primary">Tiến hàng thanh toán</button>
                </form>
            </div>
            <p>
                &nbsp;
