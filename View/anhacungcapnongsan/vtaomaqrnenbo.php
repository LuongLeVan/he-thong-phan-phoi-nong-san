      ...
      <div class="container-fluid">
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Danh sách nông sản chưa đã có mã QR</h3> 
              ...
              <form action="#" method="post" enctype="multipart/form-data">
                  <?php
                    ...
                    $p = new cnongsan();
                    $table = $p-> hienthi_nongsanchuacomaqr();
                    if($table){
                      $dem = 0;
                     ...
                     echo '</thead>';
                        while($row = mysqli_fetch_assoc($table)){
                            $fullname = $row['manongsan']."<br>";
                            $fullname .= $row['tennongsan']."<br>";
                            $fullname .= $row['soluong']."<br>";
                            $fullname .= $row['trongluong']."<br>";
                            $fullname .= $row['hamluongdinhduong']."<br>";
                            //$fullname .= $row['tenncc']."<br>";
                            //$fullname .= $row['tenncc']."<br>";
        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Danh sách nông sản đã có mã QR</h3> 
                        ...
                        while($row = mysqli_fetch_assoc($table)){
                          if ($dem == 0){
                            ...
                            echo '<tr>';
                              ...
                              echo '<td>'.$row["trangthai"].'</td>';
                              //echo "<img width=80px height=80px src='../../img/".$row['hinhanh']."'/>";
                              echo '<td>'."<img width=80px height=80px src='../../img/".$row['hinh']."'/>".'</td>';
                             ...
                             // echo '</td>';
                              ...
                              //echo '<input type="submit"  name="btnsubmit" class="btn btn-success" value="Xác nhận" id="add">';
                              echo "<td><a href='trangchuadmin.php?doitrangthai=".$row['manongsan']."'>Duyệt | </a><a style='color: red' href='trangchuadmin.php?tuchoi=".$row['manongsan']."'>Từ chối</a>";
