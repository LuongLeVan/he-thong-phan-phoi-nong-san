        ...
        <div class="p-3 py-5">
          ...
          <div class="row mt-6">
            <div class="col-md-12"><label class="labels">Họ và Tên</label>
              ...
              <?php
                echo '<input type="text" name="tennhanvien" value="'.$_SESSION['tennhanvien'].'">';
...
<?php
include_once("../../Controller/nhanvien/cnhanvien.php");
if(isset($_REQUEST["btnsubmit"])){
    ...
    $p=new cnhanvien();
    $kp=$p->capnhat_thongtin_nhanvien($manhanvien,$tennhanvien,$sdt,$email,$diachi,$tinh,$quan,$phuong,$file,$name,$type,$size);
    if($kp==1){
        echo "<script>
            alert('Thông tin đã được cập nhật');
            window.location.href='trangquanly.php?capnhatthongtin';
