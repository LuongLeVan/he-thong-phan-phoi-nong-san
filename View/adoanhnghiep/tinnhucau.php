            ...
            <ul class="navbar-nav m-auto">
              ...
              <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="#" id="dropdown04" data-toggle="dropdown" aria-haspopup="true"
                  aria-expanded="false">Nông sản</a>
        ...
        <li class="header__cart-post">
            ...
            <div class="header__cart-post-info">
                ...
                <div class="header__cart-post-body">
                    <span class="header__cart-post-name-company">CÔNG TY TNHH CÔNG NGHÊ & DỊCH VỤ ĐẤT VIỆT</span>
      ...
      <div class="container text-center text-md-start mt-5">
        ...
        <div class="row mt-3">
          ...
          <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4" style="padding-top:30px">
            ...
            <p><i class="fas fa-phone me-3"></i>0865695401 </p>
            <p><i class="fa fa-envelope"></i>nongsanvietcontact@gmail.com</p>
          </div>
          <!-- Grid column -->
        </div>
        <!-- Grid row -->
