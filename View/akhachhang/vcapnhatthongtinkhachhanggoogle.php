    ...
    <div class="row">
      <div class="col-md-3 border-right">
        <div class="d-flex flex-column align-items-center text-center p-3 py-5">
            ...
            <?php
            include("vdnkhachhanggoogle.php");
            //echo $_SESSION["login_id"];
            echo "<img class='rounded-circle mt-5' style='border-radius: 50%' width='150px' src='".$_SESSION['hinh']."'/>"; 
        ...
        <div class="p-3 py-5">
          ...
          <div class="row mt-6">
            <div class="col-md-12"><label class="labels">Họ và Tên</label>
              ...
              <?php
                echo '<input type="text" name="tenkhachhang" value="'.$_SESSION['tenkhachhang'].'">';
                //echo $_SESSION['tenkhachhang'];
              ?>
              </p>
            </div>
...
//if(isset($_REQUEST["btnsubmit"])){
    ...
    //$makhachhang=$_SESSION['mak$makhachhang'];
    //echo $makhachhang;

    //$p=new cnhacungcap();
    //$kp=$p->capnhat_thongtin($makhachhang,$tenkhachhang,$sdt,$email,$diachi,$tinh,$quan,$phuong);
...
<?php
include_once("Controller/khachhang/ckhachhang.php");
if(isset($_REQUEST["btnsubmit"])){
    $tenkhachhang=$_REQUEST["tenkhachhang"];
    $sdt=$_REQUEST["sdt"];
    $email=$_REQUEST["email"];
    ...
    $p=new ckhach_hang();
    $kp=$p->capnhat_thongtin_khachhang($makhachhang,$tenkhachhang,$sdt,$email,$diachi,$tinh,$quan,$phuong,$file,$name,$type,$size);
    if($kp==1){
        echo "<script>
            alert('Thông tin đã được cập nhật');
            window.location.href='nongsan.php?capnhatthongtinkhachhanggoogle';
        </script>"; 
    }elseif ($kp==0) {
