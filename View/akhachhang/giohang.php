...
<body class="goto-here">
        <div class="section__container">
            ...
            <div class="section__rìght" style="  margin-top: 28px;
            ">
                <div class="section__right__container">
                    <div class="section__right__title">
                        <h3 class="cart__right__title" style="color: rgb(128, 128, 137);
                            font-weight: normal; font-size: 16px;
                            margin: 0px">Giao tới</h3>
                        <a href="#">Thay đổi</a>
                    </div>
                    <div class="section__right__field">
                        <span>Nguyễn Văn Minh</span> |
                        <span>0865695401</span>
                    </div>
                    <div class="section__right__address">
                        <span class="section__right__type">Văn Phòng</span>
                        <span style="    color: rgb(128, 128, 137);
                            font-weight: normal;">60/18A Huỳnh Khương An,phường 5,quận Gò Vấp,thành Phố Hồ Chí
                            Minh</span>
                    </div>
                </div>
                <div class="section__right__coupon">
                    <div class="coupon__wrapper">
                        <div style="color: rgb(36, 36, 36);
                            margin: 0px;
                            text-transform: capitalize;
                            font-weight: 600;
                            color: #4394eb;">Tiki khuyến mãi</div>
                        <div style="color: rgb(120, 120, 120);">Có thể chọn 2
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24"
                                fill="none" class="info-icon" background="#ffffff" aria-describedby="popup-1">
                                <path
                    ...
                    <div class="righ__coupon__code">
                        <svg class="coupon-icon" width="24" height="24" viewBox="0 0 24 24" fill="none"
                ...
                <div class="right__amount">
                    <div class="right__amount__price">
                        <span >Tạm tính</span>
                        <div class="container__amount">
                            <span class="right__amount_provisional">
                                335000
                            </span>
                            <span class="right__amount__character">₫</span>
                        </div>
                    </div>

                    <div class="right__amount__price-pay">
                        <div>Thành tiền</div>
                        <div>
                            <div class="container__amount">
                                <span class="right__amount__price-fee">335000</span>
                                <span class="right__amount__character-fee">₫</span>
                            </div>
                            <span class="right__amount_VAT">(Đã bao gồm thuế VAT nếu có) </span>
                        </div>

                    </div>
                </div>
                <button type="submit" class="btn btn-danger btn-buy">Mua Hàng(1)</button>
            </div>
        </div>
</body>
