    ...
    class Pagination
{
    ...
    {   
        ...
        if ($this->_config['total_record'] > $this->_config['limit'])
        {
            ...
            if ($this->_config['current_page'] > 1)
            {
                $p .= '<li class="page_li"><a class="page_a" href="'.$this->__link('1').'">Trang đầu</a></li>';
                $p .= '<li class="page_li"><a class="page_a" href="'.$this->__link($this->_config['current_page']-1).'">Quay lại</a></li>';
            }
            ...
            for ($i = $this->_config['min']; $i <= $this->_config['max']; $i++)
            {
                ...
                if ($this->_config['current_page'] == $i){
                    $p .= '<li class="page_li"><span class="page_span">'.$i.'</span></li>';
                }
                else{
                    $p .= '<li class="page_li"><a class="page_a" href="'.$this->__link($i).'">'.$i.'</a></li>';
                }
            }
            ...
            if ($this->_config['current_page'] < $this->_config['total_page'])
            {
                $p .= '<li class="page_li"><a class="page_a" href="'.$this->__link($this->_config['current_page'] + 1).'">Tiếp</a></li>';
                $p .= '<li class="page_li"><a class="page_a" href="'.$this->__link($this->_config['total_page']).'">Trang cuối</a></li>';
            }
