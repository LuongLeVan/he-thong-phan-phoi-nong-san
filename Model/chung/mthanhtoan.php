<?php
	...
	class msanpham{
		...
		function tao_donhangkhachhangnganhang($madonhang,$makhachhang,$manongsan,$trangthai,$tongtien,$magiaodichvnpay,$manganhang){
			$con;
			$p = new clsketnoi();
			if($p->ketnoiDB($con)){
				$string = "insert into hoadon(madonhang, makhachhang, manongsan, trangthai, tongtien, magiaodichvnpay, manganhang) values";
				$string .= "('$madonhang','$makhachhang','$manongsan','$trangthai','$tongtien','$magiaodichvnpay','$manganhang')";
